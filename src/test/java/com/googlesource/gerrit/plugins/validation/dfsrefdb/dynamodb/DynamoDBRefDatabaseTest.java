...
public class DynamoDBRefDatabaseTest {
  @Mock private AmazonDynamoDBLockClient lockClient;
  @Mock private AmazonDynamoDB dynamoDBClient;
  @Mock private Configuration configuration;
  @Mock private DynamoDBRefDatabaseMetrics metrics;
  @Mock private Context context;
  @Mock private Ref ref;
  @Mock private GetItemResult pathResult;
