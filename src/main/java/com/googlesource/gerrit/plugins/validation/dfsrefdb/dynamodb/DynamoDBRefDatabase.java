...
public class DynamoDBRefDatabase implements ExtendedGlobalRefDatabase {
  ...
  String pathFor(Project.NameKey projectName, String refName) {
    Integer currentVersion = getCurrentVersion(projectName);
    String prefix = currentVersion != null ? pathForVersion(projectName, currentVersion) : "";
    return prefix + "/" + projectName + "/" + refName;
  }
  ...
  static String pathForVersion(Project.NameKey projectName, Integer version) {
